...
<template>
  <!-- Navbar -->
  <div class="fixed left-0 top-0 z-[999] w-full bg-base-100 shadow-md">
    <div class="container navbar mx-auto">
      <div class="navbar-start">
        ...
        <RouterLink :to="{ name: 'home' }" class="btn btn-ghost text-xl"
          >Kitti Salt</RouterLink
        >
      </div>
      <div class="navbar-center lg:flex">
        <div class="form-control w-[400px]">
          <input
      ...
      <div class="navbar-end">
        <!-- <button @click="toggleSearchBar()" class="btn btn-circle btn-ghost">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
            fill="none"
        ...
        >
          ...
          <ul
            tabindex="0"
            class="menu dropdown-content z-[1] w-52 rounded-md bg-base-100 p-2 shadow"
          >
        ...
        <div v-else class="flex items-center">
          <div class="dropdown dropdown-end">
            ...
            <div
              tabindex="0"
              class="card dropdown-content card-compact z-[1] mt-3 w-52 rounded-md bg-base-100 shadow"
            >
              <div class="card-body">
                <span class="text-lg font-bold text-navy-700"
                ...
                <div class="card-actions">
                  <RouterLink
                    :to="{ name: 'cart' }"
                    class="btn-primary-custom btn-block text-center"
                  >
                    View cart
                  </RouterLink>
                </div>
          ...
          <div class="dropdown dropdown-end">
            ...
            <ul
              tabindex="0"
              class="menu dropdown-content menu-sm z-[1] mt-3 w-52 rounded-md bg-base-100 p-2 shadow"
            >
              <li>
                <RouterLink
  ...
  <footer class="bg-base-200">
    <div class="container footer mx-auto p-10 text-base-content">
      <nav>
  ...
  <footer class="bg-base-100">
    <div
      class="container footer mx-auto border-t border-base-300 px-10 py-4 text-base-content"
    >
